      ...
      <div className={`home-page ${visible ? 'home-page--visible' : ''}`}>
        ...
        <Section id="projects" title={t('home.projectsTitle')} subtitle={t('home.projectsSubtitle')}>
          <div className="home-projects__links">
            ...
            <Link to="/aitasks" className="home-projects__card">
              <span className="home-projects__name">{t('home.projectAiTasksName')}</span>
              <span className="home-projects__desc">{t('home.projectAiTasksDesc')}</span>
            </Link>
        ...
        <Section id="cta" className="home-cta-section">
          <div className="home-cta">
            ...
            <div className="home-cta__actions">
              ...
              <Link to="/aitasks" className="dj-btn dj-btn--secondary dj-btn--large">
                {t('nav.aiTasks')}
              </Link>
